...
def calculate_pi(partitions, output_uri):
    ...
    :param output_uri: The URI where the output is written, typically a Google Cloud Storage
                       bucket, such as 'gs://example-bucket/pi-calc'.
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--output_uri', help="The URI where output is saved, typically a GCS bucket.")
